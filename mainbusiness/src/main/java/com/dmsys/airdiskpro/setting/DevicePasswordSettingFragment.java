...
public class DevicePasswordSettingFragment extends BaseOnOffSettingFragment
		implements DeviceVaultContract.IVaultView {
	
	IVaultPresenter mPresenter;
	
	public DevicePasswordSettingFragment() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DevicePasswordSettingFragment(OnStartResetPasswordViewListener l) {
		super();
	...
	public static DevicePasswordSettingFragment newInstance(
			OnStartResetPasswordViewListener l) {
		return new DevicePasswordSettingFragment(l);
	}
